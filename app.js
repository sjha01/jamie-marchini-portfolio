...
const CONTENT = {
  telluride: {
    title: "Telluride Mountain Village (<a href=\"https://www.olsonkundig.com/\" target=\"_blank\" rel=\"noreferrer\" class=\"detail-company-link\">Olson Kundig</a>)",
    description: [
    ...
    media: [
      page(3, "Telluride Mountain Village site plan and hotel unit details", "Overall site plan, hotel plaza, branded residence towers, and operable wood screen and balcony details."),
      page(4, "Telluride private residence tower plans and aerial", "Private residence north and south sectors, penthouse layouts, and aerial view of the residential towers."),
    ],
  },
  homewood: {
    title: "Homewood Ski Resort (<a href=\"https://www.olsonkundig.com/\" target=\"_blank\" rel=\"noreferrer\" class=\"detail-company-link\">Olson Kundig</a>)",
    description: [
    ...
    media: [
      page(5, "Homewood Ski Resort residential towers", "Typical two-unit floor plan, wall section through mezzanine and balconies, aerial of towers and Lake Tahoe, and down-slope ski-base view."),
    ],
  },
  moonlight: {
    title: "Moonlight Basin Resort (<a href=\"https://www.olsonkundig.com/\" target=\"_blank\" rel=\"noreferrer\" class=\"detail-company-link\">Olson Kundig</a>)",
    description: [
    ...
    media: [
      page(6, "Moonlight Basin cabin and hotel mock-up", "Cabin floor plan, roof level, and interior shots of the primary bedroom and bathroom from the full-scale mock-up."),
    ],
  },
  "ucsf-transplant": {
    title: "UCSF Connie Frank Transplant Center (<a href=\"https://www.nbbj.com/\" target=\"_blank\" rel=\"noreferrer\" class=\"detail-company-link\">NBBJ</a>)",
    description: [
    ...
    media: [
      page(7, "UCSF Connie Frank Transplant Center", "Reception desk plan and geometry, patient room equipment plan, and waiting area bench detail."),
    ],
  },
  "ucsf-medsurg": {
    title: "UCSF 15th Fl. Med Surg (<a href=\"https://www.nbbj.com/\" target=\"_blank\" rel=\"noreferrer\" class=\"detail-company-link\">NBBJ</a>)",
    description: [
    ...
    media: [
      page(8, "UCSF 15th floor med-surg patient room of the future", "North wing corridor cove light, nurse station desk details, staff breakroom, and nurse station."),
    ],
  },
  "the-box": {
    title: "The Box (<a href=\"https://www.moaarch.com/\" target=\"_blank\" rel=\"noreferrer\" class=\"detail-company-link\">MOA Architecture</a>)",
    description: [
    ...
    media: [
      page(9, "The Box cliffside dwelling massing studies", "Massing studies, view from kitchenette to living and balcony, and exposed rock wall with operable sleeping platforms."),
      page(10, "The Box flexible layout and material studies", "Space configuration options, material studies, and section through arrival platform, living space, and upper deck."),
    ],
  },
  "shea-brewery": {
    title: "Shea Brewery + Retail (Independent design)",
    description: [
    ...
    media: [
      page(12, "Shea Brewery + Retail site and plaza", "Conceptual sketch, main entry, view toward amphitheater, site programming, and the plaza."),
    ],
  },
  "living-core": {
    title: "Living Core (<a href=\"https://www.moaarch.com/\" target=\"_blank\" rel=\"noreferrer\" class=\"detail-company-link\">MOA Architecture</a>)",
    description: [
    ...
    media: [
      page(13, "Living Core pine-cone inspired housing concept", "Denver growth statistics, climatic operability diagrams, skin-core-circulation studies, and pine-cone inspiration."),
      page(14, "Living Core circulation and living core diagram", "Core pull-cut-carve process, reflective core shaft, plant wall, and circulation wrapping the central living core."),
    ],
  },
  "nine-yards": {
    title: "Nine Yards Hotel (University of Florida · Design 7)",
    description: [
    ...
    media: [
      page(16, "Nine Yards Hotel urban backyard concept", "Avenue versus street intensity diagram and quiet-static versus loud-dynamic relationships."),
      page(17, "Nine Yards Hotel vertical street and occupiable skin", "Internalizing the intersection, backyard layering, rib structure, office and residential units, and skin enclosure."),
    ],
  },
  "light-pavilion": {
    title: "Light Pavilion (University of Florida · Grad 1)",
    description: [
    ...
    media: [
      page(18, "Light Pavilion material and light studies", "Diagrammatic study, light-form-material studies, inspiration, and CNC process."),
      page(19, "Light Pavilion wood and metal shadow wall", "Grooved wood receivers, folded metal panels, and shadow casting along the pavilion wall."),
    ],
  },
  "stair-fragment": {
    title: "Stair Fragment (University of Florida · Design 8)",
    description: [
    ...
    media: [
      page(20, "Stair fragment axonometric and tread connections", "Internal tread connection with rebar, staggered tread connection, and axonometric study."),
      page(21, "Stair fragment brick cantilever wall system", "Brick stacking, lateral reinforcement, steel angle tread connections, and continuity of brick, steel, and wood."),
    ],
  },
  "decay-survival": {
    title: "Decay and Survival (University of Florida · Design 4)",
    description: [
    ...
    media: [
      page(22, "Decay and Survival desert refuge", "Taklamakan Desert context and refuge concept for decay and survival."),
    ],
  },
  "john-muir": {
    title: "John Muir's Rest (University of Florida · Grad 03)",
    description: [
    ...
    media: [
      page(23, "John Muir's Rest Cedar Key design-build", "Design-build meditation and seating area at Cemetery Point Park."),
    ],
  },
  "gas-works": {
    title: "Gas Works Park (University of Florida · Grad 2)",
    description: [
    ...
    media: [
      page(24, "Gas Works Park site analysis and program fragments", "Elasticity of function, viewport diagrams, spatial overlaps, and material-program fragments."),
      page(25, "Gas Works Park sections and spatial sequence", "Sections A through E studying water, ground, street, and subtractive relief drawing."),
      page(26, "Gas Works Park floor plans", "Second, first, and ground floor plans with workshop and breakout program key."),
      page(27, "Gas Works Park sketch model and material studies", "Ground-scaping model, excavation and landscape studies, and Bauhaus discipline mapping."),
    ],
  },
  "wedged-fissures": {
    title: "Wedged Fissures (University of Florida · Design 8)",
    description: [
    ...
    media: [
      page(28, "Wedged Fissures concrete casting study", "Texture studies, mechanical spine, formwork and bracing, and final casting."),
    ],
  },
  "manhattan-block": {
    title: "Manhattan Block (University of Florida · Design 7)",
    description: [
    ...
    media: [
      page(29, "Manhattan Block density and building strategies", "Site analysis, density calculations, and context-influenced block strategies."),
      page(30, "Manhattan Block envelope and structure", "Outer envelope, unit shells, primary structure, screened mesh, and column framework."),
      page(31, "Manhattan Block megacuts and courtyard", "Megacut sections revealing worker, family, and student pocket spaces across intensity zones."),
    ],
  },
  "abstracted-tower": {
    title: "Abstracted Tower (University of Florida · Design 4)",
    description: [
    ...
    media: [
      page(32, "Abstracted Tower sectional study Dubai", "Diagrammatic process, sectional study, and analytical construct."),
      page(33, "Abstracted Tower diagrammatic process", "Dream, unconscious, and transitional space diagrammatic development."),
    ],
  },
  "polar-shelter": {
    title: "Polar Shelter (University of Florida · Grad 1)",
    description: [
    ...
    media: [
      page(34, "Polar Shelter Tromsø wind and husk y pens", "Wind diagram, measure and contour studies, and sleeping spaces."),
      page(35, "Polar Shelter process relief drawing", "Process relief drawing and verb-based line abstraction indexing."),
      page(36, "Polar Shelter thickened vertical mass", "Thickened vertical mass, contouring threshold, and spatial studies betwixt and between."),
    ],
  },
  "construct-sequence": {
    title: "Construct + Sequence (University of Florida · Design 3)",
    description: [
    ...
    media: [
      page(37, "Construct + Sequence urban exploration", "Lebbeus Woods research and urban fragment site analysis."),
      page(38, "Construct + Sequence chapel and library", "Scab meditation spaces, scar library public-private relationship, and site intervention."),
      page(39, "Construct + Sequence courtyard injection", "Courtyard injection space, circulation, and programmatic composition on the grid."),
    ],
  },
  "bench-scape": {
    title: "Bench-scape (University of Florida · Design 08)",
    description: [
    ...
    media: [
      page(40, "Bench-scape Field and Fork community project", "On-site design-build bench landscape for communal gathering."),
    ],
  },
  "fort-island": {
    title: "Fort Island Chapel (University of Florida · Design 5)",
    description: [
    ...
    media: [
      page(41, "Fort Island Chapel parametric coastal pavilion", "Section A, ribbed structure, layered skin, roofscape, and circulation."),
    ],
  },
  "artist-house": {
    title: "Artist's House + Shop (University of Florida · Grad 2)",
    description: [
    ...
    media: [
      page(42, "Artist's House + Shop site and process analysis", "Human versus mechanical process, site analysis, and person-movement-time diagrams."),
      page(43, "Artist's House + Shop section and diagram", "Section A and diagrammatic process of artist craft with radial-linear axis negotiation."),
    ],
  },
  "charleston-theater": {
    title: "Charleston Theater (University of Florida · Design 6)",
    description: [
    ...
    media: [
      page(44, "Charleston Theater urban fabric study", "Spatial density, organization, urban fabric, and composition studies."),
      page(45, "Charleston Theater plans and lobby perspective", "First, second, and third floor plans with program key and lobby perspective."),
    ],
  },
};
...
function renderDetail(key) {
  ...
  if (!detailEl.classList.contains("open")) {
    ...
    requestAnimationFrame(() => {
      detailEl.style.maxHeight = "1600px";
    });
  }
